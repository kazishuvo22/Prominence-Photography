# Generated by Django 3.2.10 on 2022-03-26 17:29
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='ProminenceApp.packagescategory', verbose_name='Select Packages Category')),
                ('sub_category', smart_selects.db_fields.ChainedForeignKey(auto_choose=True, blank=True, chained_field='category', chained_model_field='category', null=True, on_delete=django.db.models.deletion.CASCADE, to='ProminenceApp.subpackagescategory', verbose_name='Select Sub-Packages Category')),
            ],
        ),
        migrations.CreateModel(
            name='General',
